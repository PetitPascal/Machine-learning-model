...
# Model name
Patient journey_XGBoost_model.rds

# Model type
XGBoost (ordinal logistic classification)

# Description
This model predicts the patient journey class (poor/problematic, okay, or good/excellent) based on 183 predictor variables included in the study.
...
•	*Outcome*: Total illness duration before diagnosis (continuous)
...
•	Macro-averaged precision: 0.42

•	Macro-averaged sensitivity: 0.40

•	Unweighted Cohen’s kappa: 0.15

•	Macro-averaged specificity: 0.73

•	Quadratic weighted kappa: 0.30

•	Multi-class log loss: 1.12

•	Multi-class AUROC: 0.63
