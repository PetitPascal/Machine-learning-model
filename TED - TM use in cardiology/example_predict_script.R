...
new_data <- data.frame(TM_know=c(1,4),barrier_tech=c(0,1),internet_connect=c(0,1),impl_eff=c(0,1),remu=c(0,1),remu2=c(0,1),
                       ...
                       extension2=c(0,1),assess_relev=c(1,0),assess_willing=c(0,1),TM_course=c(0,1),invest=c(0,1),TM_use_perso=c(0,1),
